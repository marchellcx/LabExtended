...
namespace LabExtended.Commands.Custom
{
    ...
    public class CustomGamemodeCommand : CommandBase, IServerSideCommand
    {
            ...
            [CommandParameter("ID", "The ID of the gamemode to enable.")] string id)
        {
            ...
            if (!Sender.CheckPermission($"customgamemode.enable.{gamemode.Id}"))
            {
            ...
            [CommandParameter("ID", "The ID of the gamemode to disable (specify * or all for all).")] string id)
        {
            if (id != "*" && id != "all")
            {
                ...
                if (!Sender.CheckPermission($"customgamemode.disable.{gamemode.Id}"))
                {
            ...
            {
                if (!Sender.CheckPermission("customgamemode.disable.all"))
                {
